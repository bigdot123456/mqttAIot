...
func main() {
	topic := flag.String("topic", "mtopic/#", "The topic name to/from which to publish/subscribe")
	broker := flag.String("broker", "tcp://111.229.168.108:1883", "The broker URI. ex: tcp://10.10.1.1:1883")
	//broker := flag.String("broker", "tcp://iot.eclipse.org:1883", "The broker URI. ex: tcp://10.10.1.1:1883")
	user := flag.String("user", "userA", "The User (optional)")
	password := flag.String("password", "userfast", "The password (optional)")
	id := flag.String("id", "IoTID123", "The ClientID (optional)")
	cleansess := flag.Bool("clean", false, "Set Clean Session (default false)")
	qos := flag.Int("qos", 0, "The Quality of Service 0,1,2 (default 0)")
	num := flag.Int("num", 1, "The number of messages to publish or subscribe (default 1)")
	payload := flag.String("message", "Happy Start", "The message text to publish (default empty)")
